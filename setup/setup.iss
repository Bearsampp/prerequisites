...
Filename: "{tmp}\{#appId}\vcredist_2015_2022\vc_redist.x86.exe"; Parameters: "/quiet /norestart"; StatusMsg: Installing Visual C++ 2015-2022 Runtimes x86 (VC14 VC15 VC16 VC17)...; Flags: runhidden waituntilterminated
Filename: "{tmp}\{#appId}\vcredist\VisualCppRedist_AIO_x86_x64.exe"; Parameters: "/norestart"; StatusMsg: Installing Visual C++ 2022 Redistributable - 14.40.33721.2...; Check: IsWin64; Flags: waituntilterminated
